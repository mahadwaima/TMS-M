...
class Home extends CI_Controller {
    ...
    public function Advisor_page($Advisor_id = "") {
        $page_data['page_name'] = "Advisor_page";
        $page_data['page_title'] = get_phrase('Advisor_page');
    ...
    public function payment_success($method = "", $user_id = "", $amount_paid = "") {
        ...
        $this->crud_model->enrol_trainee($user_id);
    ...
    public function dashboard($param1 = "") {
        ...
        $page_data['page_title'] = get_phrase('Advisor_dashboard');
