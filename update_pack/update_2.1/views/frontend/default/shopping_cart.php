                                ...
                                <li>
                                    <div class="cart-course-wrapper">
                                        ...
                                        <div class="details">
                                            ...
                                            <a href="<?php echo site_url('home/Advisor_page/'.$Advisor_details['id']); ?>">
                                                <div class="Advisor">
                                                    <?php echo get_phrase('by'); ?>
                                                    <span class="Advisor-name"><?php echo $Advisor_details['first_name'].' '.$Advisor_details['last_name']; ?></span>,
                                                </div>
                                            </a>
                                        </div>
