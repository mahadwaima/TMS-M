...
$Advisor_details = $this->user_model->get_all_user($course_details['user_id'])->row_array();
?>
      ...
      <div class="col-lg-8">
        ...
        <div class="created-row">
          <span class="created-by">
            ...
            <a href="<?php echo site_url('home/Advisor_page/'.$course_details['user_id']); ?>"><?php echo $Advisor_details['first_name'].' '.$Advisor_details['last_name']; ?></a>
          </span>
...
<section class="course-content-area">
  ...
  <div class="about-Advisor-box">
    <div class="about-Advisor-title">
      <?php echo get_phrase('about_the_Advisor'); ?>
    </div>
    <div class="row">
      <div class="col-lg-4">
        <div class="about-Advisor-image">
          <img src="<?php echo $this->user_model->get_user_image_url($Advisor_details['id']); ?>" alt="" class="img-fluid">
          <ul>
            <!-- <li><i class="fas fa-star"></i><b>4.4</b> Average Rating</li> -->
            <li><i class="fas fa-comment"></i><b>
              <?php echo $this->crud_model->get_Advisor_wise_course_ratings($Advisor_details['id'], 'course')->num_rows(); ?>
            </b> <?php echo get_phrase('reviews'); ?></li>
            <li><i class="fas fa-user"></i><b>
              <?php
              $course_ids = $this->crud_model->get_Advisor_wise_courses($Advisor_details['id'], 'simple_array');
              $this->db->select('user_id');
              $this->db->distinct();
              $this->db->where_in('course_id', $course_ids);
              echo $this->db->get('enrol')->num_rows();
              ?>
            </b> <?php echo get_phrase('trainees') ?></li>
            <li><i class="fas fa-play-circle"></i><b>
              <?php echo $this->crud_model->get_Advisor_wise_courses($Advisor_details['id'])->num_rows(); ?>
            </b> <?php echo get_phrase('courses'); ?></li>
          </ul>
        </div>
      </div>
      <div class="col-lg-8">
        <div class="about-Advisor-details view-more-parent">
          <div class="view-more" onclick="viewMore(this)">+ <?php echo get_phrase('view_more'); ?></div>
          <div class="Advisor-name">
            <a href="<?php echo site_url('home/Advisor_page/'.$course_details['user_id']); ?>"><?php echo $Advisor_details['first_name'].' '.$Advisor_details['last_name']; ?></a>
          </div>
          <div class="Advisor-title">
            <?php echo $Advisor_details['title']; ?>
          </div>
          <div class="Advisor-bio">
            <?php echo $Advisor_details['biography']; ?>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="trainee-feedback-box">
    <div class="trainee-feedback-title">
      <?php echo get_phrase('trainee_feedback'); ?>
    </div>
    <div class="row">
      <div class="col-lg-3">
