            ...
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form class="required-form" action="<?php echo site_url('admin/system_settings/system_update'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="language"><?php echo get_phrase('trainee_email_verification'); ?></label>
                            <select class="form-control select2" data-toggle="select2" name="trainee_email_verification" id="trainee_email_verification">
                                <option value="enable" <?php if(get_settings('trainee_email_verification') == "enable") echo 'selected'; ?>><?php echo get_phrase('enable'); ?></option>
                                <option value="disable" <?php if(get_settings('trainee_email_verification') == "disable") echo 'selected'; ?>><?php echo get_phrase('disable'); ?></option>
                            </select>
                        </div>
